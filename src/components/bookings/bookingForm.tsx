...
export default function BookingForm({
    ...
    return (
        <form className="space-y-4">
            ...
            <h2>
                {t('order.details', { defaultValue: 'Enter your details:' })}
            </h2>
            <div>
                <label
                    htmlFor="firstname"
            ...
            <div className="flex items-center">
                ...
                <label htmlFor="paperless" className="text-sm font-medium">
                    {t('bookingForm.paperless', { defaultValue: 'I want a paperless confirmation (email only)' })}
                </label>
            </div>
            ...
            <div>
                <label htmlFor="cardHolderName" className="block text-sm font-medium">
                    {t('bookingForm.cardHolderName', { defaultValue: 'Card holder name' })}
                </label>
                <input
                    type="text"
                    id="cardHolderName"
